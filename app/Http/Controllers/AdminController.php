...
class AdminController extends Controller
{
    ...
    public function update_category(Request $request, $id){
      ...
      public function search_product(Request $request){
        ...
        $data = Product::where('title', 'LIKE', '%'.$search.'%')->orWhere('category', 'LIKE', '%'.$search.'%')->
        paginate(3);
        return view('admin.view_product', compact('data'));
      }
      ...
      public function on_the_way($id){
        ...
        $data->save();
        toastr()->timeOut(10000)->closeButton()->addSuccess('Order on the way');
      ...
      public function delevered($id){
        ...
        $data->save();
         toastr()->timeOut(10000)->closeButton()->addSuccess('Order delivered');
        return redirect('/view_orders');
      }
